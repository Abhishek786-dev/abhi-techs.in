...
<nav class="hide-on-small-only">
  <ul class="side-nav fixed section table-of-contents">
    <li class="logo">
      ...
      >
        <h1>Abhishek<span class="brown-text light">Software Engineer</span>
        </h1></a>
    </li>
    <li class="bold">
      <a
    ...
    <li class="bold">
      <a
        ...
        ><i class="mdi-action-grade small"></i><span>Certification</span></a
      >
    </li>
    <li class="bold">
      <a
    ...
    <li class="bold">
      <a
        aria-label="Open Abhishek resume in a new tab"
        href="<?php echo base_url('static/cv/Abhishek_kumbhare_Software_Engineer.pdf')?>"
        target="_blank"
...
<nav class="hide-on-large only">
  <ul id="slide-out" class="side-nav">
    ...
    <li class="bold">
      <a
        aria-label="Open Abhi's Resume in a new tab"
        href="<?php echo base_url('static/cv/Abhishek_Kumbhare_Software_Eng.pdf')?>"
        target="_blank"
        class="waves-effect waves-dark grey-text text-darken-3"
        ><i class="mdi-action-description small"></i><span>Resume</span></a
      >
